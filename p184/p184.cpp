...
int main(int args, char **argv){
	...
	*/
	 ...
	 *
	 *			AC above (0,0)
	 *			ay*cx>ax*cy <=> cy > ay*cx/ax
	 *
	 *			BC below (0,0)
	 *			by*cx<bx*cy <=> cy < by*cx/bx
	 *
	 *	CASE 2: Ax < Bx (no vertical side)
	 *			Ay > By
	 *			Ay > Cy
	 *			Ax < Cx
	 *			Bx < Cx and Cx > 0
	 ...
	 *			Ay > 0
	 *
	 *			subcase 1: By > Cy => BC above (0;0) AC below (0;0)
	 *			ay*cx>ax*cy <=> cy < ay*cx/ax
	 *			by*cx<bx*cy <=> cy > by*cx/bx
	 *
	 *			subcase 2: By < Cy => BC below (0;0) AC above (0;0)
	 *			ay*cx>ax*cy <=> cy > ay*cx/ax
	 *			by*cx<bx*cy <=> cy < by*cx/bx
	 *
	*/
